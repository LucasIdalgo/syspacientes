    ...
    <div class="container">
      ...
      <div class="jumbotron">
        ...
        <table class="table">
            ...
            <tbody>
               <?php
                  $sql = "SELECT idPessoa, nome, datanascimento, cep, endereco,
                  numero, complemento, cidade, estado, telefone, celular, email FROM pessoas ORDER BY idPessoa";
                  $resp = mysqli_query($conexao_bd, $sql);
                  while($rows=mysqli_fetch_row($resp)){
                     ...
                     if($tipoAcesso == 1){
                        ...
                        echo("<a class='btn btn-lg btn-danger'  href='javascript:excluirPessoa($id)' role='button'>Excluir</a>");
                     }else{
                       echo("-");
                     }
                     echo("</td>");
